...
use rvtraveller\ComposerConverter\Composer\ComposerizeWordpressCommand;
use Symfony\Component\Console\Helper\HelperSet;
use Symfony\Component\Console\Helper\QuestionHelper;
use Symfony\Component\Console\Input\InputInterface;
use Symfony\Component\Console\Output\OutputInterface;

class TestableComposerizeWordpressCommand extends ComposerizeWordpressCommand
{
    ...
    protected function initialize(InputInterface $input, OutputInterface $output)
    {
        ...
        /**
         * @var \rvtraveller\ComposerConverter\Tests\Application $application
         */
